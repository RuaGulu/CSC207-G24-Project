...
public class LoginUseCaseFactoryTest {
    ...
    @Test
    public void loggedinViewCreateTest(){
        LoggedinView loggedinView = LoggedInUseCaseFactory.create(viewManagerModel,loggedInViewModel,weatherViewModel,airQualityViewModel,loginUserDataAccessInterface,weatherDataAccessObject,groupViewModel,groupDataAccessInterface);
