...
public class CommonWeather implements Weather{
    ...
    public CommonWeather(String location, String time, int tempC, int tempF, String condition) {
    ...
    public static class WeatherBuilder {
        ...
        public CommonWeather build() {
            return new CommonWeather(location, time, tempC, tempF, condition);
        }
    }
